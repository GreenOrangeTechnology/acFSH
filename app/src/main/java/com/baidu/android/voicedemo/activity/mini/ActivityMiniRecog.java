...
public class ActivityMiniRecog extends AppCompatActivity implements EventListener {
    ...
    private void startOther() {
        //PackageManager packageManager = com.baidu.android.voicedemo.activity.mini.ActivityMiniRecog.this.getPackageManager();
        //Intent intent=new Intent();
        //try {
       ...
       // }
        ...
        //  com.UCMobile  com.UCMobile.main.UCMobile   http://blog.csdn.net/foreverhuylee/article/details/20062319
        //常用包名和activity   com.tencent.mm  com.tencent.mm.ui.LauncherUI
        //如何查看 http://blog.csdn.net/wanglha/article/details/48241749
        ComponentName componentName = new ComponentName("com.tencent.mm","com.tencent.mm.ui.LauncherUI");
        Intent intent=new Intent();
        intent.setComponent(componentName);
        intent.setAction(Intent.ACTION_VIEW);
